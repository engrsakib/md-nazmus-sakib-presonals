  ...
  return (
    ...
    >
      <h1 className="text-center text-4xl font-bold mb-12">
        ...
        <br />
        <span className="text-info">Work Experience</span>
      </h1>
      <div className="relative">
        {/* Timeline Line */}
        <div className="absolute hidden 2xl:inline left-1/2 transform -translate-x-1/2 h-full border-l-4 border-info"></div>
        ...
        <div className="space-y-12">
          {experiences.map((experience, index) => (
            ...
            >
              ...
              {/* Content */}
              <div
                className={`max-w-md p-6 shadow-lg rounded-lg ${
